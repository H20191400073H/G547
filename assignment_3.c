...
#define USB_KINGSTON_PID  0x1607		
...
static struct usb_device_id usbdev_table [] = {
	{USB_DEVICE(USB_KINGSTON_VID, USB_KINGSTON_PID)},
...
{	
	...
	if(id->idProduct == USB_KINGSTON_PID && id->idVendor == USB_KINGSTON_VID )
	{
...
MODULE_AUTHOR("G lokesh 2019H1400073H");
MODULE_LICENSE("GPL");
