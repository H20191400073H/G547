...
#define HP_PID  0x3307
#define HP_VID  0x03f0//HP




#define SN_PID  0x5535
#define SN_VID  0x0781//WD

#define USB_EP_IN  		//  from the point of HOST 's view
#define USB_EP_OUT  	
...
static int hppendrive_probe(struct usb_interface *interface, const struct usb_device_id *id)
{
	int i;
...
static struct usb_driver usbdev_driver = {
	name: "hppendrive",  //name of the device
	probe: hppendrive_probe, // Whenever Device is plugged in
...
MODULE_LICENSE("GPL");
MODULE_LICENSE("GPL");
MODULE_AUTHOR("lokesh <h20191400073@hyderabad.bits-pilani.ac.in> ");
